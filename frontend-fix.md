Evaluating the pending items to fix the frontend: 

# ENLIST

The Enlist page is about bringing capital into the Fair Launch. 

-Remove the arrows which go up and down on the entry part -- There is no need to manually click to increase, people can just deposit however much they would like into the system. 
- I'd like to see the underlying pool -- there is a meteora pool - i'd like to have more of a link there. 
- Maybe consider what the frontends have looked like previously for new launches on meteora, or perhaps even what new launches look like on pump.fun. If you make things more like that, then it will be better / useful. 
...
- You need something to the left hand side, which pulls a SMB Gen2 or Gen3, and allows you to select which one holds your BANANAS. 
- If you have an NFT that has BANANAS, it should load it up. 
- Tracking total fees, and your MONKE's current share of the rewards. 

# OPERATIONS

- This is incorrect, it is too big, and the information is not concise. Also the laserstream check is in the way of the navigator. 
- As a follow up note - we need to change the location of wallet notification announcements. 